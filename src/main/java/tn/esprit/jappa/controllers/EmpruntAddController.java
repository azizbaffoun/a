    ...
    private void handleAdd() {
        ...
        try {
            ...
            if (loanDuration > 2 || loanCount > 2) {
                ...
                maintenance.setDescription("Automatic maintenance after " + 
                    (loanDuration > 2 ? "extended loan period" : "multiple loans"));
                maintenance.setCout(0.0); // Default cost, to be updated by maintenance staff
                maintenance.setStatutMaintenance(MaintenanceStatus.PENDING);
                
                maintenanceService.add(maintenance);
                showAlert("Information", "Maintenance record automatically created for this material.", Alert.AlertType.INFORMATION);
            }
