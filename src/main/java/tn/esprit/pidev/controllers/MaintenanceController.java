...
public class MaintenanceController {
    ...
    private void initialize() {
        ...
        listHeader.setText(String.format(headerFormat,
                "ID", "Date", "Description", "Status", "Material"));
        ...
        maintenanceListView.setCellFactory(param -> new ListCell<Maintenance>() {
            ...
            protected void updateItem(Maintenance item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    try {
                        Materiel materiel = materielService.getById(item.getMaintenanceID());
                        setText(String.format("Maintenance #%d - %s - %s - %s",
    ...
    private void handleAdd() {
        ...
        try {
            ...
            maintenance.setMaintenanceID(materielComboBox.getValue().getId());
    ...
    private void updateMaintenance(Maintenance selected) {
        try {
            selected.setMaintenanceID(materielComboBox.getValue().getId());
    ...
    private void handleDelete() {
        ...
        try {
            ...
            if (empruntService.isDateTaken(selected.getMaintenanceID(), LocalDate.now())) {
    ...
    private void fillFields(Maintenance maintenance) {
        try {
            Materiel materiel = materielService.getById(maintenance.getMaintenanceID());
