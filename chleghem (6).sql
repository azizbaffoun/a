...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2025 at 08:23 PM
...
(7, 3, '2025-03-06 04:55:26', 15, 'Gradin', 'Valide', 1);
...
(9, 'vdfcv', 'cxvxvcxvcxv', '2025-03-01', '2025-03-08', 'vxcvcx', NULL, NULL, 120);
...
(2, 'az', 'GAFSA', 1500, 'Réservé'),
(5, 'houma', 'dqsdsqd', 1500, 'Disponible'),
(6, 'ezaezae', 'zaezae', 150, 'Réservé');

-- --------------------------------------------------------

--
-- Table structure for table `terrain_siege`
--
...
--
-- Dumping data for table `terrain_siege`
--

INSERT INTO `terrain_siege` (`siegeID`, `terrainID`, `rangee`, `numero`, `statut`, `prix`) VALUES
...
--
-- Triggers `terrain_siege`
--
DELIMITER $$
CREATE TRIGGER `update_terrain_status_after_seat_available` AFTER UPDATE ON `terrain_siege` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_terrain_status_after_seat_reservation` AFTER UPDATE ON `terrain_siege` FOR EACH ROW BEGIN
...
--
-- Indexes for table `reservation_siege`
--
ALTER TABLE `reservation_siege`
...
--
-- Indexes for table `terrain_siege`
--
ALTER TABLE `terrain_siege`
...
--
-- AUTO_INCREMENT for table `terrain_siege`
--
ALTER TABLE `terrain_siege`
...
--
ALTER TABLE `reservation_billet`
  ADD CONSTRAINT `reservation_billet_ibfk_1` FOREIGN KEY (`reservationID`) REFERENCES `reservation` (`ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `reservation_billet_ibfk_2` FOREIGN KEY (`billetID`) REFERENCES `billet` (`ID`);

--
-- Constraints for table `reservation_siege`
--
ALTER TABLE `reservation_siege`
  ADD CONSTRAINT `reservation_siege_ibfk_1` FOREIGN KEY (`reservationID`) REFERENCES `reservationterrain` (`ID`),
  ADD CONSTRAINT `reservation_siege_ibfk_2` FOREIGN KEY (`siegeID`) REFERENCES `terrain_siege` (`siegeID`);

--
-- Constraints for table `terrain_siege`
--
ALTER TABLE `terrain_siege`
  ADD CONSTRAINT `terrain_siege_ibfk_1` FOREIGN KEY (`terrainID`) REFERENCES `terrain` (`courtID`);
